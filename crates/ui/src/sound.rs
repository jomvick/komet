...
//! - `KOMET_DISABLE_SOUND` env kill-switch + the `soundEnabled` ui-setting;
...
const DISABLE_ENV: &str = "KOMET_DISABLE_SOUND";
...
fn temp_path() -> PathBuf {
    ...
    std::env::temp_dir().join(format!("komet-sound-{}-{id}.wav", std::process::id()))
}
