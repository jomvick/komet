...
/// Human platform label (komet settings.devices.tsx `platformLabel`).
    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let rows: Vec<AnyElement> = devices
            ...
            .map(|(ix, device)| {
                ...
                // tone so it "cuts" the tile — komet settings.devices.tsx
                ...
                // "Added {time ago}" — always present (komet settings.devices.tsx).
                ...
                widgets::card_row(&theme, ix == 0)
                    ...
                    .child(
                        // `opacity-70 hover:opacity-100` (komet: also rises on
