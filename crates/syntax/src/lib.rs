//! Syntax-highlighting contracts shared by Komet's desktop surfaces.
//!
...
fn rust_configuration() -> Result<HighlightConfiguration, HighlightError> {
    ...
    // `constant.builtin`. Komet preserves those structural roles separately.
