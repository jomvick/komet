...
//! (`komet_doc::apply_op`). Test infrastructure only (`mock-server` feature):
//! komet-sync's client tests and komet-engine's two-engine integration tests
...
use komet_doc::{RegistryRow, RowOp, apply_op};
