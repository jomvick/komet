...
//! [`komet_doc::RegistryDoc`] under a lock. Wire frames are JSON text —
...
use komet_doc::{PendingBatch, RegistryDoc, RegistryRow, StateOutcome};
...
// ── stats (RoomStatsSnapshot-compatible so SyncStatus/`komet sync` render it) ─
