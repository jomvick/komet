//! komet-doc — session & workspace Loro doc schemas and the typed mirror layer.
//!
//! Port of komet's `packages/session-doc`. The schema SHAPE (container names, part maps with
...
//!
//! Load-bearing invariant (measured in komet, `oplog-shape.test.ts`): message parts are a
