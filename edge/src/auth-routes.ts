/**
 * The /auth/* HTTP surface absorbed from komet's apps/server:
 *
 ...
 * for the user to paste into the device that started the flow (`komet login`),
